...
- (void) sendCompletionNotification {
    [[NSNotificationCenter defaultCenter] postNotificationName:self.completionNotificationName object:self userInfo:
     [NSDictionary dictionaryWithObjectsAndKeys:[self copy],@"self",results,@"results",
      nil]];
}
/**
...
- (void) sendNetworkErrorNotification {
    [[NSNotificationCenter defaultCenter] postNotificationName:[BaseCommand getNetworkErrorNotificationname] object:self userInfo:
     [NSDictionary dictionaryWithObjectsAndKeys:[self copy],@"self",results,@"results",
      nil]];
}
/**
...
- (void) sendLoginNeededNotification {
    [[NSNotificationCenter defaultCenter] postNotificationName:[BaseCommand getLoginNotificationName] object:self userInfo:
     [NSDictionary dictionaryWithObjectsAndKeys:[self copy],@"self",
      nil]];
